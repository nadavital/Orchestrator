  ...
  return [
    ...
    },
    {
      ...
      codexAssets: [
        ...
        { basename: 'notebook-preview-panel-CAO-aRhM.js', terms: ['Read only', 'Run all', 'Restart kernel', 'Raw output', 'Notebook output', 'details', 'summary', 'descriptionMarkdown', 'cellTitle', 'outputSummaries', 'summaryMarkdown', 'Python', 'max-w-3xl', 'gap-4', 'px-4 py-4', 'px-4 py-3', 'border-t', 'IPYNB'] },
        ...
        { basename: 'PopcornElectronWorkbookPanel-TofX9KRG.js', terms: ['popcorn-electron-workbook-panel', 'renderHeaderZoomControl'] },
        { basename: 'PopcornElectronPresentationPanel-DNKOkXvp.js', terms: ['popcorn-electron-presentation-panel', 'popcorn-presentation-page-navigation', 'popcorn-presentation-zoom-select', 'popcorn-presentation-thumbnails'] }
      ],
      smokeChecks: ['filesContentSearch', 'filesActionMenuSharedSections', 'workbenchFileTabActionMenuSharedSections', 'filesArtifactHeaderTitleType', 'filesPdfPreviewControls', 'filesPdfPresentationMode', 'filesDocumentPageControls', 'filesSpreadsheetSlidesArtifactBoundary', 'filesSpreadsheetRenderer', 'filesSlidesRenderer', 'filesSpreadsheetControls', 'filesSlidesControls', 'filesNotebookReadOnlyControls', 'filesNotebookOutputRendering', 'filesNotebookCellDisclosure', 'filesNotebookExecutionCount', 'filesNotebookCellMetadata', 'filesNotebookOutputSummaries', 'filesNotebookRawOutputDisclosure', 'filesNotebookCodeSnippet', 'filesNotebookCellSpacing', 'filesNotebookOutputChrome', 'reviewFullSourceRows', 'reviewFullSourceBlame'],
      statusWhenCovered: 'fixture-covered',
      caveat: 'Local file/source behavior is covered, including Codex-style artifact header title/type splitting for PDF/DOCX/IPYNB/XLSX/PPTX previews, local PDF page/zoom/invert-color controls and presentation mode, local DOCX page/zoom controls, lightweight XLSX workbook and PPTX slide outline rendering, local XLSX sheet/zoom controls, local PPTX slide/zoom/thumbnail controls, read-only notebook artifact controls, basic notebook output rendering, Codex-style notebook cell disclosure shells, notebook execution-count labels, notebook metadata titles/descriptions, notebook output summary markdown, raw-output disclosures, text/plain-before-JSON notebook MIME precedence, Python-titled notebook code snippets, Codex-like notebook cell spacing/width, and Codex-like notebook output/source chrome. Full XLSX/PPTX/PDF/DOCX artifact renderer fidelity, PDF canvas/annotation rendering, and provider-backed comments/blame remain incomplete.',
      next: 'Prioritize real artifact renderer controls/rendering, deeper per-output item styling, or provider metadata, not more local tree styling.'
    },
    {
