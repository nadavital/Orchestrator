  ...
  return [
    ...
    },
    {
      ...
      codexAssets: [
        ...
        { basename: 'PopcornElectronDocumentPanel-BnYPHweX.js', terms: ['tables.add', 'images.add', 'Popcorn Document', 'SECTION_BREAK_TYPE', 'pageSetup', 'columns'] },
