  ...
  return [
    ...
    },
    {
      ...
      codexAssets: [
        ...
        { basename: 'PopcornElectronDocumentPanel-BnYPHweX.js', terms: ['tables.add', 'Popcorn Document', 'SECTION_BREAK_TYPE', 'pageSetup', 'columns'] },
        ...
        { basename: 'PopcornElectronPresentationPanel-DNKOkXvp.js', terms: ['popcorn-electron-presentation-panel', 'popcorn-presentation-page-navigation', 'popcorn-presentation-zoom-select', 'popcorn-presentation-thumbnails', 'popcorn-presentation-codex-thumbnail-rail', 'popcorn-presentation-thumbnail-stack', 'popcorn-presentation-add-slide', 'popcorn-presentation-notes-panel', 'popcorn-presentation-notes', 'shapes.add', 'position:{left', 'background', 'fill', 'color'] },
