  ...
  return [
    ...
    },
    {
      ...
      codexAssets: [
        ...
        { basename: 'PopcornElectronWorkbookPanel-TofX9KRG.js', terms: ['popcorn-electron-workbook-panel', 'renderHeaderZoomControl', 'popcorn-formula-bar', 'popcorn-selection', 'recalculate'] },
        { basename: 'PopcornElectronPresentationPanel-DNKOkXvp.js', terms: ['popcorn-electron-presentation-panel', 'popcorn-presentation-page-navigation', 'popcorn-presentation-zoom-select', 'popcorn-presentation-thumbnails', 'popcorn-presentation-codex-thumbnail-rail', 'popcorn-presentation-thumbnail-stack', 'popcorn-presentation-add-slide', 'popcorn-presentation-notes-panel', 'popcorn-presentation-notes'] },
      ...
      smokeChecks: ['filesContentSearch', 'fileSourceSearch', 'filesActionMenuSharedSections', 'workbenchFileTabActionMenuSharedSections', 'workbenchFileTabCodexActionLabels', 'workbenchFileTabCodexActionCluster', 'filesArtifactHeaderTitleType', 'filesArtifactPreviewControls', 'filesArtifactOpenOptions', 'filesPdfPreviewControls', 'filesPdfPresentationMode', 'filesPdfAnnotations', 'filesDocumentPageControls', 'filesDocumentPdfZoomMenu', 'filesSpreadsheetSlidesArtifactBoundary', 'filesSpreadsheetRenderer', 'filesSlidesRenderer', 'filesSpreadsheetControls', 'filesSpreadsheetSheetTabs', 'filesSpreadsheetActiveCell', 'filesSpreadsheetFormulaEvaluation', 'filesSlidesControls', 'filesSlidesSpeakerNotes', 'filesSlidesThumbnailRail', 'filesOfficeZoomMenu', 'filesNotebookReadOnlyControls', 'filesNotebookOutputRendering', 'filesNotebookCellDisclosure', 'filesNotebookExecutionCount', 'filesNotebookCellMetadata', 'filesNotebookOutputSummaries', 'filesNotebookRawOutputDisclosure', 'filesNotebookCodeSnippet', 'filesNotebookCellSpacing', 'filesNotebookOutputChrome', 'filesNotebookOutputItemChrome', 'filesNotebookRichOutputItemChrome', 'reviewFullSourceRows', 'reviewFullSourceBlame'],
      statusWhenCovered: 'fixture-covered',
      caveat: 'Local file/source behavior is covered, including Codex-style Workbench file-source action labels and compact options/open action cluster, shared content-search-input source find, Codex-style artifact header title/type splitting for PDF/DOCX/IPYNB/XLSX/PPTX previews, Codex-style artifact Open/options header controls, local PDF page/zoom/invert-color controls, local PDF annotation-mode comments, and presentation mode, local DOCX page/zoom controls, shared PDF/DOCX preset/fit zoom menu, lightweight XLSX workbook and PPTX slide outline rendering, local XLSX sheet/zoom controls plus Codex-like workbook sheet tabs, read-only active-cell/formula-bar chrome, scoped read-only formula extraction/evaluation, and shared XLSX/PPTX preset/fit zoom menu, local PPTX slide/zoom controls plus a Codex-style left thumbnail rail, read-only add-slide affordance, read-only speaker notes, and shared preset/fit zoom menu, read-only notebook artifact controls, basic notebook output rendering, Codex-style notebook cell disclosure shells, notebook execution-count labels, notebook metadata titles/descriptions, notebook output summary markdown, raw-output disclosures, text/plain-before-JSON notebook MIME precedence, Python-titled notebook code snippets, Codex-like notebook cell spacing/width, Codex-like notebook output/source chrome, Codex-like stream/text output item chrome, and separate markdown/error/image notebook item chrome. Full XLSX/PPTX/PDF/DOCX artifact renderer fidelity, editable workbook behavior, PDF canvas rendering, provider-backed annotation metadata, and provider-backed comments/blame/artifact metadata remain incomplete.',
      ...
      openIssues: [
        ...
        {
          category: 'renderer-fidelity',
          issue: 'Editable workbook behavior and formula editing are not implemented beyond scoped read-only formula extraction/evaluation.',
