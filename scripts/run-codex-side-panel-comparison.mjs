  ...
  return [
    ...
    },
    {
      ...
      codexAssets: [
        ...
        { basename: 'PopcornElectronWorkbookPanel-TofX9KRG.js', terms: ['popcorn-electron-workbook-panel', 'renderHeaderZoomControl', 'popcorn-formula-bar', 'popcorn-selection', 'recalculate', 'format', 'fill', 'font', 'merge()', 'columnWidthPx', 'rowHeightPx', 'freezePanes', 'popcorn-freeze-column-line', 'popcorn-freeze-row-handle', 'wrapText', 'horizontalAlignment', 'verticalAlignment', 'tables.add', 'TableStyleMedium2', 'showFilterButton', 'conditionalFormats.addColorScale', 'conditionalFormats.add(`cellIs`', 'operator:`greaterThan`', 'dataValidation', 'showInputMessage', 'promptTitle', 'prompt', 'popcorn-data-validation-overlay', 'applyRangeBorders', 'charts.add', 'comments.addThread', 'sparklines.add', 'shapes.add', 'images.add', 'geometry:`upArrow`', 'anchor:{from'] },
