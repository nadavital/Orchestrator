...
- Full escalated side-panel comparison on 2026-05-28 refreshed all 27 local captures with `mismatchCount=0` and `needsSmokeCount=0` after repairing the Files overflow fixture. Remaining local comparison work is the multi-window focus/menu-routing assertion failure; the other blocked rows require nonblank live Codex screenshots or provider/runtime contracts.
