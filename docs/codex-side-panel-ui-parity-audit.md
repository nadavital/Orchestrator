...
1. Shell/tab foundation and panel/header interaction first: keep the dedicated comparison row green whenever changing the left sidebar, main titlebar, Workbench right panel, or Terminal bottom panel, and review those screenshots together because the user-visible mismatch can be in the relationship between surfaces rather than in any one panel.
