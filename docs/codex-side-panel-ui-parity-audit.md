...
Verification: `npm run pack:mac` passed and rebuilt `dist/mac-arm64/Orchestrator.app`; `npm run install:mac` installed it to `/Applications/Orchestrator.app`. Elevated full installed comparison `npm run compare:codex-side-panels -- --run-smoke --full --installed --no-fail --smoke-out tmp/side-panel-visual-inventory-installed-full` passed with 27 captures, `fixture-covered=8`, `aligned=2`, `mismatch=0`, `blocked=0`, `needsSmoke=0`, and `needsProof=0`; installed manifest `/Users/nadav/Desktop/Orchestrator/tmp/side-panel-visual-inventory-installed-full/manifest.json`, created at `2026-05-27T03:37:08.348Z`; comparison report `/Users/nadav/Desktop/Orchestrator/tmp/codex-side-panel-comparison/comparison-report.json`, created at `2026-05-27T03:37:08.604Z`. The installed multi-window evidence JSON is `/var/folders/bj/cxpn19xd78q4k1h9w4c_99700000gn/T/orchestrator-automated-ui-smoke-multi-window-focus-1779852980419.json` and includes `loadedDeepLinkDoesNotLeavePendingNavigation=true`.
