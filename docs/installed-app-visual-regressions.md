...
| Duplicate vertical scrollbars in submenus | Menus look broken and are harder to use. | Normalize menu max-height and inner scroll ownership so only the menu body scrolls. | Targeted screenshots of affected chat/options menus. |
